...
//      $element['#title'] .= '<span class="caret-icon">'._bootstrap_icon('chevron-right').'</span>';
  ...
  if($element["#theme"] == 'menu_link__menu_menu_float') {
    if($element['#title'] == 'Clients') {
      $element['#title'] = '<span style="font-size:15px;" data-toggle="tooltip" data-original-title="Projects">'."<i class='fa fa-briefcase'></i>". '&nbsp;&nbsp;' . $element['#title'].'</span>';
    }
